(() => {
    ...
    (() => {
        ...
        function tabs() {
            ...
            function initTabs(tabsBlock) {
                ...
                if (tabsContent.length) tabsContent.forEach(((tabsContentItem, index) => {
                    ...
                    if (!tabsContentItem.hidden) tabsContentItem.classList.add("tabs__body-active"); else tabsContentItem.classList.remove("tabs__body-active");
                }));
            }
                ...
                if (tabsContent.length > 0) {
                    ...
                    tabsContent.forEach(((tabsContentItem, index) => {
                        if (tabsTitles[index].classList.contains("_tab-active")) {
                            ...
                            setTimeout((() => {
                                tabsContentItem.classList.add("tabs__body-active");
                            }), 10);
                            if (isHash && !tabsContentItem.closest(".popup")) setHash(`tab-${tabsBlockIndex}-${index}`);
                        } else {
                            setTimeout((() => {
                                tabsContentItem.classList.remove("tabs__body-active");
                            }), 10);
        ...
        function initSliders() {
            if (document.querySelector(".videos__slider")) new swiper_core_Swiper(".videos__slider", {
                ...
                navigation: {
                    prevEl: ".videos__slider-prev",
                    nextEl: ".videos__slider-next"
                },
                on: {}
            });
            if (document.querySelector(".about-us-thumbs__slider")) var aboutThumbsSlider = new swiper_core_Swiper(".about-us-thumbs__slider", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 2,
                ...
                navigation: {
                    prevEl: ".about-us-thumbs__slider-prev",
                    nextEl: ".about-us-thumbs__slider-next"
                },
                on: {
                    ...
                    click: function(aboutThumbsSlider) {
                        ...
                        if (clickedIndex === activeIndex) aboutThumbsSlider.slideNext(); else {
                            aboutThumbsSlider.slideNext();
                            setTimeout((() => {
                                aboutThumbsSlider.slideNext();
                            }), 350);
                        }
            ...
            if (document.querySelector(".about-us__slider")) var aboutSlider = new swiper_core_Swiper(".about-us__slider", {
                ...
                speed: 300,
                pagination: {
                    el: ".about-us__slider-pagination",
                    clickable: true
                },
                breakpoints: {
                    1280: {
            ...
            if (document.querySelector(".scheme__slider")) new swiper_core_Swiper(".scheme__slider", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
                ...
                navigation: {
                    prevEl: ".scheme-button-prev",
                    nextEl: ".scheme-button-next"
                },
                breakpoints: {
                    768: {
                        slidesPerView: 2,
        ...
        function headerScroll() {
            ...
            if (header) {
                ...
                const burgerButton = document.querySelector(".burger-button--desktop");
                ...
                document.addEventListener("windowScroll", (function(e) {
                    ...
                    if (scrollTop >= startPoint) {
                        if (!header.classList.contains("_header-scroll")) {
                            ...
                            headerMenu?.classList.add("xl:flex");
                            headerOrder?.classList.add("xl:flex");
                            burgerButton?.classList.remove("xl:flex");
                            burgerButton?.classList.add("xl:hidden");
                        ...
                        headerMenu?.classList.remove("xl:flex");
                        headerOrder?.classList.remove("xl:flex");
                        burgerButton?.classList.remove("xl:hidden");
                        burgerButton?.classList.add("xl:flex");
                        headerIcons?.forEach((icon => {
        ...
        const videoDurations = document.querySelectorAll(".videoDuration");
        if (videos) playButtons.forEach(((playButton, index) => {
            ...
            playButton.addEventListener("click", (() => {
                ...
                videoDuration.classList.add("opacity-0", "pointer-events-none");
            }));
        }));
        window["FLS"] = 0;
        isWebp();
